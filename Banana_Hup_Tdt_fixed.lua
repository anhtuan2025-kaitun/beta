...
-- === Auto-inserted safety helpers (added by automated fixer) ===
...
-- Use SafeSet(obj, 'Disabled', true) instead of direct assignments where appropriate.
...
repeat
    local start = plr.PlayerGui:FindFirstChild("Main"):FindFirstChild("Loading") and game:IsLoaded()
    wait()
until start
...
local TeddyGay = loadstring(game:HttpGet("https://raw.githubusercontent.com/anhtuan2025-kaitun/beta/refs/heads/main/tuanhubuiteddy.txt"))()
...
hookfunction(require(game:GetService("ReplicatedStorage"):FindFirstChild("GuideModule")).ChangeDisplayedNPC, function()
end)
-- hookfunction(error, function() end) -- commented out by fixer
-- hookfunction(warn, function() end) -- commented out by fixer
...
Hop = function()
    pcall(function()
        for count = 1, math.random(40, 75) do
        ...
        if _G.DummyMan then
            pcall(function()
                if plr.PlayerGui.Main.Quest.Visible == false then
                    ...
                    replicated:FindFirstChild("Remotes"):FindFirstChild("CommF_"):InvokeServer(unpack(xxx))
                else
...
AuraSkin = function(HakiID)
    ...
    replicated:FindFirstChild("Modules"):FindFirstChild("Net"):FindFirstChild("RF/FruitCustomizerRF"):InvokeServer(unpack(args));
end;
        ...
        if _G.Auto_DonAcces then
            pcall(function()
                if replicated.Remotes.CommF_:InvokeServer("GetUnlockables").FlamingoAccess == nil and plr.Data.Level.Value >= 1500 then
                    FruitPrice = {}
                    FruitStore = {}
                    for i, v in next, replicated:FindFirstChild("Remotes").CommF_:InvokeServer("GetFruits") do
                        if v.Price >= 1000000 then
...
Mirage:AddButton({
    ...
    Description = "",
    Callback = function()
        replicated:FindFirstChild("Remotes"):FindFirstChild("CommF_"):InvokeServer("RaceV4Progress", "Begin")
        replicated:FindFirstChild("Remotes"):FindFirstChild("CommF_"):InvokeServer("RaceV4Progress", "Check")
        replicated:FindFirstChild("Remotes"):FindFirstChild("CommF_"):InvokeServer("RaceV4Progress", "Teleport")
        replicated:FindFirstChild("Remotes"):FindFirstChild("CommF_"):InvokeServer("RaceV4Progress", "Continue")
    end
})
...
checkQuesta = function()
    ...
    pcall(function()
        ...
        game:GetService("ReplicatedStorage"):FindFirstChild("Modules"):FindFirstChild("Net"):FindFirstChild("RF/DragonHunter"):InvokeServer(unpack(c))
    end)
    local d, e = pcall(function()
        b = game:GetService("ReplicatedStorage"):FindFirstChild("Modules"):FindFirstChild("Net"):FindFirstChild("RF/DragonHunter"):InvokeServer(unpack(a))
    end)
    local f = false;
    local g;
    local h;
...
SeaEvent:AddButton({
    ...
    Callback = function()
        replicated:FindFirstChild("Remotes"):FindFirstChild("CommF_"):InvokeServer("InfoLeviathan", "2")
    end
})
        ...
        if _G.FrozenTP then
            pcall(function()
                if workspace.Map:FindFirstChild("LeviathanGate") then
                    ...
                    replicated:FindFirstChild("Remotes"):FindFirstChild("CommF_"):InvokeServer("OpenLeviathanGate")
                end
            end)
        end
    end
            ...
            pcall(function()
                ...
                elseif myBoat then
                    if plr.Character.Humanoid.Sit == false then
                        ...
                        until _G.SailBoat_Hydra == false or plr.Character:FindFirstChild("Humanoid").Sit == false
                        plr.Character.Humanoid.Sit = false
                    end
                end
            end)
            ...
            pcall(function()
                ...
                elseif myBoat and not (CheckShark() and _G.Shark or CheckTerrorShark() and _G.TerrorShark or CheckFishCrew() and _G.MobCrew or CheckPiranha() and _G.Piranha) and not (CheckEnemiesBoat() and _G.FishBoat) and not (CheckSeaBeast() and _G.SeaBeast1) and not (_G.PGB and CheckPirateGrandBrigade()) and not (_G.HCM and CheckHauntedCrew()) and not (_G.Leviathan1 and CheckLeviathan()) then
                    if plr.Character.Humanoid.Sit == false then
                        ...
                        until _G.SailBoats == false or (CheckShark() and _G.Shark or CheckTerrorShark() and _G.TerrorShark or CheckFishCrew() and _G.MobCrew or CheckPiranha() and _G.Piranha) or CheckSeaBeast() and _G.SeaBeast1 or CheckEnemiesBoat() and _G.FishBoat or _G.Leviathan1 and CheckLeviathan() or _G.HCM and CheckHauntedCrew() or _G.PGB and CheckPirateGrandBrigade() or plr.Character:FindFirstChild("Humanoid").Sit == false
                        plr.Character.Humanoid.Sit = false
                    end
                end
            end)
            ...
            pcall(function()
                for _, v in pairs(ply:GetChildren()) do
                    if v.Name ~= plr.Name and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                        replicated:FindFirstChild("Remotes"):FindFirstChild("CommF_"):InvokeServer("AcceptAlly", v.Name)
                    end
                end
            end)
        end
...
function AttackNoCoolDown()
    ...
    local attackEvent = storage:FindFirstChild("Modules"):FindFirstChild("Net"):FindFirstChild("RE/RegisterAttack")
    local hitEvent = storage:FindFirstChild("Modules"):FindFirstChild("Net"):FindFirstChild("RE/RegisterHit")

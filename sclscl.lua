-- == FILE ĐÃ ĐƯỢC SẮP XẾP LẠI VÀ GIỮ NGUYÊN CƠ CHẾ ==--
-- Giữ nguyên tên biến và logic; chỉ dọn bố cục + giữ comment chính bằng tiếng Việt.
-- CẢNH BÁO: Đây là script exploit/auto-farm cho Roblox. Chạy có rủi ro (ban, ToS).
...
-- 5) TƯƠNG TÁC MẠNG / REMOTE
-- 6) VÒNG LẶP TỰ ĐỘNG / COROUTINES
-- 7) CHỨC NĂNG PHỤ / TIỆN ÍCH
-- 8) KẾT THÚC / GHI CHÚ

-- LƯU Ý: Mình chỉ chèn tiêu đề phần để bạn dễ tìm và chỉnh sửa. Không thay đổi logic hay tên biến.


-- >>> PHẦN: KẾT THÚC / GHI CHÚ <<<
-- --------------------------
-- == FILE ĐÃ ĐƯỢC SẮP XẾP LẠI VÀ GIỮ NGUYÊN CƠ CHẾ ==--
-- Giữ nguyên tên biến và logic; chỉ dọn bố cục + giữ comment chính bằng tiếng Việt.
-- CẢNH BÁO: Đây là script exploit/auto-farm cho Roblox. Chạy có rủi ro (ban, ToS).

-- Phiên bản có chú thích của deobfuscated_final.lua


-- == HOOKS (can thiệp hành vi trò chơi) ==--
...
-- >>> PHẦN: HÀM VÀ MAP VỊ TRÍ <<<
-- -------------------------
function MaterialMon()

-- == BIẾN TOÀN CỤC / CẤU HÌNH ==--

-- >>> PHẦN: BIẾN TOÀN CỤC / CẤU HÌNH <<<
-- --------------------------------
-- BẬT/TẮT TOÀN CỤC: Sử dụng cờ toàn cục (ví dụ: _G.AutoFarm) để bật/tắt chức năng.
...
-- == TƯƠNG TÁC MẠNG / REMOTE ==--

-- >>> PHẦN: TƯƠNG TÁC MẠNG / REMOTE <<<
-- -------------------------------
            ...
            if tonumber(v9.maxPlayers) > tonumber(v9.playing) then
                ...
                if v10 == true then
                    ...
                    pcall(function()
                        ...
                        wait()
-- == CHỨC NĂNG PHỤ / TIỆN ÍCH ==--

-- >>> PHẦN: CHỨC NĂNG PHỤ / TIỆN ÍCH <<<
-- --------------------------------
...
-- GHI CHÚ (tiếng Anh): UI: Creating GUI elements for user controls/toggles.
...
-- == VÒNG LẶP TỰ ĐỘNG / COROUTINES ==--

-- >>> PHẦN: VÒNG LẶP TỰ ĐỘNG / COROUTINES <<<
-- -------------------------------------
spawn(function()
...
-- GHI CHÚ (tiếng Anh): ENV/METATABLE: manipulating globals or metatables (advanced behavior).
...
local v466 = loadstring(game:HttpGet("https://raw.githubusercontent.com/AnhDangNhoEm/UiRedz/refs/heads/main/RedzUiV.txt"))():MakeWindow({
    ...
    Title = "Tu\225\186\165n Hello hub",
    SubTitle = "by real_tuanhellohub",
...
l_ImageButton_0.Image = "rbxassetid://92310734122830"
...
local v486 = v466:MakeTab({"Auto Fishing", "rbxassetid://92310734122830"})
...
v484:AddDiscordInvite({
    ...
    Logo = "rbxassetid://92310734122830",
    Invite = "link"
})
v484:AddDiscordInvite({
    Name = "Anh",
    Description = "linkfacebook",
    Logo = "rbxassetid://92310734122830",
...
v484:AddDiscordInvite({
    ...
    Description = "",
    Logo = "rbxassetid://92310734122830",
    Invite = "https://www.youtube.com/"
})
v484:AddDiscordInvite({
    Name = "AnhTuan",
    Description ="tictoc",
    Logo = "rbxassetid://92310734122830",
    Invite = "https://www.tiktok.com/"
})
            ...
            if _G.FarmBone and World3 then
                ...
                pcall(function()
                    ...
                    elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - l_v592_0.Position).Magnitude > 2000 then
                        TP1(l_v592_0)
                        wait(0.1)
-- GHI CHÚ (tiếng Anh): FOR LOOP: iterating over numeric range.
                        for _ = 1, 8 do

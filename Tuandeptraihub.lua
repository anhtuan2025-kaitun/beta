...
local Window = Library:MakeWindow({
  Title = "Tuanhello Hub : Blox Fruits",
  SubTitle = "by Nguyễn Anh Tuấn",
  SaveFolder = "Tuanhello Hub | Blox Fruits.lua"
})
...
Discord:AddDiscordInvite({
    Name = "Tuanhello Hub",
    Description = "Vào discord của mình",
    Logo = "rbxassetid://98474018544837",
    Invite = "https://discord.gg/"
})
Discord:AddDiscordInvite({
    Name = "infinityscript discord",
    Description = "Discord dev script!",
...
Shop:AddSection("Fighting Shop-lại gần npc mới mua được")
Shop:AddButton({
    Name = "Black Leg",
    Callback = function()
